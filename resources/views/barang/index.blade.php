        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="{{ route('barang.edit', $barang->id_barang) }}" class="btn btn-warning btn-sm mr-2">Edit</a>
                            <a href="{{ route('barang.show', $barang->id_barang) }}" class="btn btn-info btn-sm mr-2">Show</a>
